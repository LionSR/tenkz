% Regression: plane_test — renders (a) 4x4 oblique PEPS sheet, physical=up, boundary legs (RMP sec2fig4b top).
% Formula: (a) 4x4 oblique PEPS sheet, physical=up, boundary legs (RMP sec2fig4b top)
