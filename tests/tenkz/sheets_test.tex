% Regression: sheets_test — exercises role-list sheet stacks, pairing interfaces, contraction, and outer legs.
% Formula: sheets_test — acceptance for the role-list sheet axis (sheets=k lifted
