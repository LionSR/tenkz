...
\[
  \begin{tenkzfree}
    ...
    \tnjoin[role=operator, route=arc]{W.north}{N.west}
    \tnjoin[role=operator, route=arc]{N.east}{E.north}
    \tnjoin[role=operator, route=arc]{E.south}{J.north east}
    \tnjoin[role=operator, route=arc]{J.south west}{S.east}
    \tnjoin[role=operator, route=arc]{S.west}{W.south}
  \end{tenkzfree}
  \;=\;\delta_{i,j}\;
  \begin{tenkzfree}
