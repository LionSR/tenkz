...
\[
  ...
  \begin{tenkz}[
    ...
    \tnwire[kind=string, species=operator, name=s-rS-rW]
      {rS.90}{rW.270}
    \tn[at=midway i and rN, skin=none, name=j-s-rW-rN-1]{}
    \tnwire[kind=string, species=operator, name=s-rW-rN-1,
      cross={under at crossing of s-rW-rN-1 and iphys,
             over at crossing of s-rW-rN-1 and s-rW-rN-2}]
      {rW.45}{j-s-rW-rN-1}
    \tnwire[kind=string, species=operator, name=s-rW-rN-2]
      {j-s-rW-rN-1}{rN.180}
