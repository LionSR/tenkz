...
\[
  \begin{tenkzfree}
    ...
    \tnjoin[role=operator, route=arc]{w.north}{l.south}
    \tnjoin[role=operator, route=arc]{l.east}{n.west}
    \tnjoin[role=operator, route=arc]{n.east}{e.north}
    \tnjoin[role=operator, route=arc]{e.south}{s.east}
    ...
    \tnjoin[role=operator, route=arc]{tw.north}{tn.west}
  ...
  \begin{tenkzfree}
    ...
    \tnjoin[role=operator, route=arc]{te.south}{ts.east}
