...
\[ \frac1{|G|}\sum_{g\in G}
  \begin{tenkz}[rows={wire,wire,wire}, cols=3, bonds=none, size=s]
    \tn[skin=ring, at=(1,2), name=n, label pos=e]{L_g}
    \tn[skin=ring, at=(2,3), name=e, label pos=s]{L_g}
    \tn[skin=ring, at=(3,2), name=s, label pos=w]{L_g}
    \tn[skin=ring, at=(2,1), name=w, label pos=n]{L_g}
  ...
  \begin{tenkz}[rows={wire,wire,wire}, cols=3, bonds=none, size=s]
    ...
    \tnwire[kind=string, species=projector, name=ring, closed, route=orth,
      via={
        d, n,
        (1,3), e,
        (3,3), s,
