...
\[
  \begin{tenkzfree}
    ...
    \tnjoin[route=arc,role=operator]{left.north}{top.west}
  \end{tenkzfree}
  \;=\;
  \begin{tenkzfree}
    \tnput[box]{n}{(0mm,8mm)}{} \tnput[box]{e}{(8mm,0mm)}{}
    ...
    \tnjoin[route=arc,role=operator]{right.south}{bottom.east}
  \end{tenkzfree}
\]
