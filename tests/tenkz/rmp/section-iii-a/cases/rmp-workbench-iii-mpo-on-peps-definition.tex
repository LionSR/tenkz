...
% Ink: Kernel plane MPO ring with four boxes, beside a five-leg PEPS star.
...
% Capabilities: kernel, typed-ports, plane-frame
\[
  \tenkzkernel
  ...
  \end{tenkz}
  \;=\;
  \begin{tenkz}[rows={wire,wire,wire}, cols=3, frame=plane,
                metrics=compact, bonds=none]
