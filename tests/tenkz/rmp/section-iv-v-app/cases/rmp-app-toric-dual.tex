...
%   interior diagonals recall the original lattice on a dashed rail.
...
\[
  ...
  % lattice's edges crossing under the dual sheet, dashed as the source
  % dashes them.
  \begin{tenkz}[lattice={3x3}, frame=plane, bonds=none, boundary=none]
    ...
    \tnwire[stroke=dashed]{cnw}{cse} \tnwire[stroke=dashed]{cne}{csw}
