% Regression: atoms_test — exercises multiwire atoms, sparse legs, holes, traces, triangle skins, and bond directions.
% Formula: atoms_test — the remaining atom keys: wires=k (two-site gates, tall X),
