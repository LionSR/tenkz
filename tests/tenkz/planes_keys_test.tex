% Regression: planes_keys_test — imported current-behavior fixture from the handoff corpus.
% Formula: (3 x 0.60 = 1.8 >
...
% warnings (and ONLY these): planes-interleave (item 1, part 3),
...
% static 1.4 left 0.85mm of white between 1.76mm dots, plane_sweep2 z_S2).
...
% an integer multiple of the rise doubles dots side by side) yet still
% draw what it was told.
\textbf{(3) planes, sheet sep=1.65 at 5x5 (warns: interleave)}\par\smallskip
