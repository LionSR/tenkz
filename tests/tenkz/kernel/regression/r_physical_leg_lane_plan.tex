...
\cs_new_eq:NN
  \__tenkz_test_lp_production_consume:nn
  \__tenkz_kernel_r_leg_consume:nn
\cs_set_protected:Npn \__tenkz_kernel_r_leg_consume:nn #1#2
  {
    \bool_if:NT \l__tenkz_test_lp_production_bool
      {\int_incr:N \l__tenkz_test_lp_consume_count_int}
    \__tenkz_test_lp_production_consume:nn {#1}{#2}
  }
