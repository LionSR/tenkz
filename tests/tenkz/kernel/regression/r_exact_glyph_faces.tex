...
% carrier basis, while flat and circular live glyphs retain measurement
% parity.  The affine live-contour contract has its own focused fixture.
...
\int_compare:nNnF { \g__tenkz_test_live_parity_count_int } = {3}
