...
\begin{tenkz}[lattice={2x3}, bonds=none]
  \tn[at=(1,1), skin=dot]{V}
  \tn[at=(1,3)]{}
  \tnwire[kind=string, via={(2,1)}]{(1,1)}{(1,3)}
\end{tenkz}
...
\begin{tenkz}[lattice={2x4}, bonds=none]
  \tn[at=(1,1), skin=dot]{Y}
  \tn[at=(1,4), skin=dot]{Z}
  \tnwire[kind=string, via={(2,1),(2,4)}]{(1,1)}{(1,4)}
\end{tenkz}
% An index wire draws the chord between its ends whatever waypoints it
% names, so its ends read each other and X keeps its free south.
\begin{tenkz}[lattice={2x3}, bonds=none]
  \tn[at=(1,1)]{}
  \tn[at=(1,3), skin=dot]{X}
  \tnwire[via={(2,1)}]{(1,1)}{(1,3)}
\end{tenkz}
\ExplSyntaxOn
