...
\begin{tenkzlattice}[rows=3, cols=3, sheets={ket, op, op, bra},
  ...
  % Sheet indices run bottom-up: these marked virtual contractions belong to
  % O_2 on sheet 1 and O_1 on sheet 2.  Their three generated physical
  % contractions per site remain unchanged.
