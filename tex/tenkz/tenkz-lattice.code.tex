...
\pgfkeys{
  ...
  % `cup[={m}]` ties the ket and bra virtual boundary indices at each
  % site on that side.  `trace` remains reserved for the distinct
  % same-sheet closure of opposing sides.
    ...
    \str_case:nnF {#2}
      {
        ...
        {trace} { \msg_warning:nnnn {tenkz}{lattice-side-deferred}
                  ...
                  \tenkz@event{warning|picture=\the\tenkz@pictureid|%
                    code=side-deferred|side=#1|policy=trace}
