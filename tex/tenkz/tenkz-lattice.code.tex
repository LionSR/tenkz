...
\cs_new_protected:Npn \tenkzl_corner_label:nnnnnn #1#2#3#4#5#6
  {
    ...
    % site.  Publish that one semantic adjacency so the overlap audit can
    % distinguish it from an accidental collision with any other site.
    \tenkzl_map:nn { \tenkzl_cx:n{#2} } { \tenkzl_cy:n{#4} }
    \tenkz@event{label-anchor-site|picture=\the\tenkz@pictureid|%
      label=\the\tenkz@bboxuid|x=\number\l__tenkzl_px_dim|%
