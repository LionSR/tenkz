...
\seq_new:N \l__tenkz_string_disjoint_seq     % model-proven disjoint pairs
...
\cs_new_protected:Npn \__tenkz_string_reset:
  {
    ...
    \seq_clear:N \l__tenkz_string_disjoint_seq
...
\cs_new_protected:Npn \__tenkz_string_disjoint:nn #1#2
  {
    \seq_put_right:Nn \l__tenkz_string_disjoint_seq { {#1} {#2} }
  }
...
\cs_new_protected:Npn \__tenkz_string_police_pair:nn #1#2
  {
    ...
    \seq_if_in:NnT \l__tenkz_string_disjoint_seq { {#1} {#2} }
      { \bool_set_true:N \l_tmpa_bool }
    \seq_if_in:NnT \l__tenkz_string_disjoint_seq { {#2} {#1} }
      { \bool_set_true:N \l_tmpa_bool }
