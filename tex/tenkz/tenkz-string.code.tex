...
% Count intersections between non-adjacent path segments without mutating or
% recursively subdividing the saved path.  Adjacent branches meet by
% construction; the first and last branches share a seam when either the path
% closes formally or an open route returns to its initial point.
