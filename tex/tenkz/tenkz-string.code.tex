...
% same arclength and crossing queries as a string, but stays out of the string
% crossing ledger and ink pass because its owner controls both ordering and
% rendering.
\cs_new_protected:Npn \__tenkz_string_save_route:nn #1#2
  {
    \prop_if_in:NnT \l__tenkz_string_kind_prop {#1}
      { \msg_error:nnn {tenkz}{string-redeclared} {#1} }
    \prop_put:Nnn \l__tenkz_string_kind_prop {#1} {route}
