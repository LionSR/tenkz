...
\int_new:N \l__tenkz_string_components_before_int
        ...
        \seq_map_inline:Nn \l__tenkz_string_segments_seq
          {
            ...
            \tl_if_eq:NNT
              ...
              \c_spath_curveto_tl
              {
                % Split the cubic into disposable halves and intersect them
                % after removing their shared midpoint.  Unlike spath's
                % full self-splitter, this terminates promptly for ordinary
                % non-looping cubics as well as detecting the loop branch.
                \spath_split_at_normalised:Nn
                  \l__tenkz_string_tmp_tl {1/2}
                \spath_components_to_seq:NV
                  \l__tenkz_string_pts_seq
                  \l__tenkz_string_tmp_tl
                \seq_pop_left:NN
                  \l__tenkz_string_pts_seq \l_tmpa_tl
                \seq_pop_left:NN
                  \l__tenkz_string_pts_seq \l_tmpb_tl
                \spath_shorten_at_end:Nn \l_tmpa_tl
                  {\dim_eval:n {\__tenkz_dim:n {crossgap} / 8}}
                \spath_shorten_at_start:Nn \l_tmpb_tl
                  {\dim_eval:n {\__tenkz_dim:n {crossgap} / 8}}
        ...
        \str_if_eq:nnTF {#1} {#2}
          ...
          }
          {
            ...
            \spath_components_to_seq:NV
              ...
              \l__tenkz_string_self_path_tl
            \__tenkz_string_find_inserted_boundary:
...
\cs_new_protected:Npn \__tenkz_string_find_inserted_boundary:
  {
    ...
    \seq_map_indexed_inline:Nn
      \l__tenkz_string_before_components_seq
      {
        \int_compare:nNnT {\l__tenkz_string_insertion_int} = {0}
          {
            \tl_set:Nn \l__tenkz_string_first_tl {##2}
            \tl_set:Ne \l__tenkz_string_last_tl
              {
                \seq_item:Nn
                  \l__tenkz_string_after_components_seq {##1}
              }
            \tl_if_eq:NNF
              \l__tenkz_string_first_tl \l__tenkz_string_last_tl
              { \int_set:Nn \l__tenkz_string_insertion_int {##1} }
          }
      }
    \int_compare:nNnT {\l__tenkz_string_insertion_int} = {0}
      {
        \int_set:Nn \l__tenkz_string_insertion_int
