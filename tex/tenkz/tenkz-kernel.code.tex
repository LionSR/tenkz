...
\cs_new_protected:Npn \__tenkz_kernel_addr_leg:nN #1#2
  {
    ...
    \str_if_eq:VnF \l_tmpa_tl {cell}
      {
        \msg_error:nneee {tenkz}{kernel-address-operand}
    ...
    \keys_define:nn {#1}
      {
        ...
        #2 / unknown .code:n =
          {
            \msg_error:nneee {tenkz}{kernel-choice} {#2} {##1} {#3}
              { \tl_use:N \l__tenkz_model_last_tl }
          }
      }
  }
...
\cs_new_protected:Npn \__tenkz_kernel_desugar_boundary:n #1
  {
    ...
    \str_case:nnF {#1}
      ...
      {
        \msg_error:nneee {tenkz}{kernel-choice} {boundary} {#1}
...
\cs_new_protected:Npn \__tenkz_kernel_desugar_physical:n #1
  {
    ...
    \str_case:nnF {#1}
      ...
      {
        \msg_error:nneee {tenkz}{kernel-choice} {physical} {#1}
