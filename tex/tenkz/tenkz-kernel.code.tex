...
% are two spellings of one extent, and the equation draws them so.  An
% unclassed glyph carries the key of the skin's own default.
\cs_new_protected:Npn \__tenkz_kernel_eq_extent_key:nN #1#2
  {
    \__tenkz_model_get:nnN {#1} {size} #2
    \quark_if_no_value:NT #2 { \tl_set:Nn #2 {default} }
  }
