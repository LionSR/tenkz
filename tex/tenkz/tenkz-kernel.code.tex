...
\clist_new:N \l__tenkz_kernel_r_skin_over_string_clist
    ...
    \str_if_eq:eeTF {#3} {over}
      {
        ...
        \exp_args:NVV \__tenkz_kernel_r_pairing_over_string:nn
          \l__tenkz_kernel_r_b_tl \l__tenkz_kernel_r_sid_tl
      }
      {
        \exp_args:NVV \__tenkz_string_under:nn
...
\cs_new_protected:Npn \__tenkz_kernel_r_pairing_over_string:nn #1#2
  {
    ...
    % ordinary string, the opaque host must redraw that string locally.
        ...
        \str_if_eq:VnT \l__tenkz_kernel_scratch_tl {pairing}
          {
            \tl_set_eq:NN \l__tenkz_kernel_r_b_tl
              \l__tenkz_kernel_r_c_tl
            \prop_get:NnN \l__tenkz_kernel_named_prop {#2}
              \l__tenkz_kernel_r_c_tl
            \quark_if_no_value:NF \l__tenkz_kernel_r_c_tl
              {
                \__tenkz_model_get:nnN
                ...
                \str_if_eq:VnT \l__tenkz_kernel_scratch_tl {string}
                  {
                    ...
                    \quark_if_no_value:NTF \l__tenkz_kernel_r_c_tl
                      ...
                      {
                        \clist_set:NV
                          \l__tenkz_kernel_r_skin_over_string_clist
                          \l__tenkz_kernel_r_c_tl
                        \clist_if_in:NnF
                          \l__tenkz_kernel_r_skin_over_string_clist {#2}
                          {
                            \clist_put_right:Nn
                              \l__tenkz_kernel_r_skin_over_string_clist
                              {#2}
