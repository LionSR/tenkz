        ...
        \__tenkz_geom_place_cell:nnee {#1} {kpic}
          {
            \fp_eval:n
              {
                \l__tenkz_kernel_r_row_tl
                + ( sind( \__tenkz_kernel_r_item:nn {#1} {face} ) > cosd(45)
                      ? 0
                      : ( sind( \__tenkz_kernel_r_item:nn {#1} {face} )
                            < -cosd(45)
          ...
          }
          {
            \fp_eval:n
              {
                \l__tenkz_kernel_r_col_tl
                + ( cosd( \__tenkz_kernel_r_item:nn {#1} {face} ) > cosd(45)
                      ? \l__tenkz_kernel_r_b_tl - 1
                      : ( cosd( \__tenkz_kernel_r_item:nn {#1} {face} )
                            < -cosd(45)
                          ? 0
                          : \__tenkz_kernel_r_item:nn {#1} {slot} - 1 ) )
              }
