            ...
            \str_case:VnF \l__tenkz_kernel_r_tl
              {
                ...
                {skin}  { \__tenkz_kernel_r_skin_wire_prepare:n {#1} }
              }
              {
                \msg_error:nnee {tenkz}{kernel-render-todo}
...
% Render a materialized skin WIRE.  Numeric anchors belong to the already
% transformed glyph node, so they stay in local coordinates.  Only the curve
% tangents receive the carrying frame's turn.  A non-first slot contributes
% its settled transverse coordinate while the numeric anchor supplies the
% coordinate normal to that face.
\cs_new_protected:Npn \__tenkz_kernel_r_skin_wire:n #1
  {
    \__tenkz_model_get:nnN {#1} {host} \l__tenkz_kernel_r_c_tl
    \__tenkz_model_get:nnN {#1} {species}
    ...
    \__tenkz_kernel_r_skin_wire_end:VNN
      ...
      \l__tenkz_kernel_r_skin_from_tl \l__tenkz_kernel_r_row_tl
    \__tenkz_kernel_r_skin_wire_end:VNN
      \l__tenkz_kernel_r_skin_to_tl
      \l__tenkz_kernel_r_skin_to_tl \l__tenkz_kernel_r_col_tl
    \tl_set:Ne \l__tenkz_kernel_scratch_tl
      {
        ...
        to
          [
            out =
              \fp_eval:n
                {
                  \l__tenkz_kernel_r_row_tl - 180
                  + \l__tenkz_kernel_r_ink_turn_tl
                } ,
            in =
              \fp_eval:n
                {
                  \l__tenkz_kernel_r_col_tl + 180
                  + \l__tenkz_kernel_r_ink_turn_tl
                }
          ]
...
\cs_new_protected:Npn \__tenkz_kernel_r_skin_wire_end:nNN #1#2#3
  {
    ...
    \pgfextractx \l__tenkz_kernel_r_north_x_dim
      {
        \pgfpointanchor
          {\tl_use:N \l__tenkz_kernel_r_c_tl}{\tl_use:N #3}
      }
    \pgfextracty \l__tenkz_kernel_r_north_y_dim
      {
        \pgfpointanchor
            ...
            \tl_set:Ne \l__tenkz_kernel_r_b_tl
              {
                (
                  \__tenkz_kernel_r_pt:n { \l__tenkz_kernel_r_x_fp } ,
                  \dim_use:N \l__tenkz_kernel_r_north_y_dim
                )
              }
          }
        {s}
        ...
        {e}
          {
            \tl_set:Ne \l__tenkz_kernel_r_b_tl
              {
                (
                  \dim_use:N \l__tenkz_kernel_r_north_x_dim ,
                  \__tenkz_kernel_r_pt:n { \l__tenkz_kernel_r_y_fp }
                )
              }
          }
    ...
    \tl_set_eq:NN #2 \l__tenkz_kernel_r_b_tl
  }
        ...
        \__tenkz_model_record_wire:e
          {
            ...
            origin = skin ,
            host = #1 ,
            name = \tl_use:N \l__tenkz_kernel_r_b_tl ,
...
\cs_new_protected:Npn \__tenkz_kernel_skin_pairing_end:nnnn #1#2#3#4
  {
    \exp_args:Ne \__tenkz_kernel_node_new:nN {#2.#3@#4}
      \l__tenkz_kernel_scratch_tl
    ...
    \__tenkz_kernel_node_put:Nne
      \l__tenkz_kernel_scratch_tl {face} {#3}
    \__tenkz_kernel_node_put:Nne
      \l__tenkz_kernel_scratch_tl {slot} {#4}
    \__tenkz_model_complete:nnn
