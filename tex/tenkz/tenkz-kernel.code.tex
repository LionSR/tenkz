...
\cs_new_protected:Npn \__tenkz_kernel_addr_leg:nN #1#2
  {
    ...
    \__tenkz_kernel_node_put:NnV #2 {cell} \l__tenkz_kernel_child_tl
  }
...
\cs_new_protected:Npn \__tenkz_kernel_flag:nnn #1#2#3
  {
    \keys_define:nn {#1}
      {
        #2 .code:n = { \__tenkz_kernel_stage_put:nn {#3} {true} },
        #2 .default:n =
      }
  }
...
\keys_define:nn { tenkz-kernel-setup }
  {
    ...
    strict .code:n = { \bool_set_true:N \l__tenkz_kernel_strict_bool },
    strict .default:n = ,
...
\cs_new_protected:Npn \__tenkz_kernel_newrow:
  {
    \int_incr:N \l__tenkz_kernel_row_int
    \int_set:Nn \l__tenkz_kernel_col_int { 1 }
  }
