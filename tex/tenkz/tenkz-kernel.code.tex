            ...
            \bool_if:NT \l__tenkz_kernel_lab_cell_bool
              {
                ...
                \bool_if:NT \l__tenkz_kernel_lab_far_bool
                  {
...
% one: a step along a row or a column takes the face it crosses.
...
% carrier runs through the bead, and the two faces that run crosses are
% taken: a policy leg reaches the bead along the face it grows from, and an
% index wire between two cells of one column runs north and south while one
% along a row runs east and west.  A bending carrier turns where its own
% waypoints say, so it leaves the bead through no face this stage can name.
            ...
            \int_compare:nNnTF
              ...
              = { \l__tenkz_kernel_lab_col_tl }
              {
                \int_compare:nNnF
                  ...
                  = { \l__tenkz_kernel_lab_row_tl }
                  {
                    \__tenkz_kernel_r_label_mark_side:nn {#2} {n}
                    \__tenkz_kernel_r_label_mark_side:nn {#2} {s}
                  }
              }
              {
                \int_compare:nNnT
                  ...
                  = { \l__tenkz_kernel_lab_row_tl }
                  {
                    \__tenkz_kernel_r_label_mark_side:nn {#2} {e}
                    \__tenkz_kernel_r_label_mark_side:nn {#2} {w}
                  }
              }
          }
      }
