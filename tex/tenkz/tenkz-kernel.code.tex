...
\prop_new:N \l__tenkz_kernel_r_skin_over_string_prop
...
\tl_new:N   \l__tenkz_kernel_r_cross_record_tl
...
\cs_new_protected:Npn \__tenkz_kernel_r_crossings:n #1
  {
    \tl_set:Nn \l__tenkz_kernel_r_cross_record_tl {#1}
    \__tenkz_model_get:nnN {#1} {cross} \l__tenkz_kernel_r_tl
    \quark_if_no_value:NF \l__tenkz_kernel_r_tl
      {
        \__tenkz_kernel_r_sid:nN {#1} \l__tenkz_kernel_r_sid_tl
...
\cs_new_protected:Npn \__tenkz_kernel_r_cross_pair:nnn #1#2#3
  {
    ...
    \str_if_eq:eeTF {#3} {over}
      ...
      }
      {
        ...
        \__tenkz_kernel_r_pairing_over_string:
      }
  }
\cs_new_protected:Npn \__tenkz_kernel_r_pairing_over_string:
  {
    \__tenkz_model_get:nnN
      { \l__tenkz_kernel_r_cross_record_tl } {kind}
      \l__tenkz_kernel_r_c_tl
    \str_if_eq:VnT \l__tenkz_kernel_r_c_tl {pairing}
      {
        \prop_get:NVN \l__tenkz_kernel_named_prop
          \l__tenkz_kernel_r_b_tl \l__tenkz_kernel_r_c_tl
        \quark_if_no_value:NF \l__tenkz_kernel_r_c_tl
          {
            \__tenkz_model_get:nnN
              ...
              \l__tenkz_kernel_scratch_tl
            \str_if_eq:VnT \l__tenkz_kernel_scratch_tl {string}
              {
                \__tenkz_model_get:nnN
                  { \l__tenkz_kernel_r_cross_record_tl } {host}
                  \l__tenkz_kernel_scratch_tl
                \prop_get:NVN \l__tenkz_kernel_r_skin_over_string_prop
                  \l__tenkz_kernel_scratch_tl \l__tenkz_kernel_r_c_tl
                \quark_if_no_value:NTF \l__tenkz_kernel_r_c_tl
                  {
                    \prop_put:NVV
                      \l__tenkz_kernel_r_skin_over_string_prop
                      \l__tenkz_kernel_scratch_tl
                      \l__tenkz_kernel_r_b_tl
                  }
                  {
                    \exp_args:NVV \clist_if_in:nnF
                      \l__tenkz_kernel_r_c_tl
                      \l__tenkz_kernel_r_b_tl
                      {
                        \prop_put:NVx
                          ...
                          \l__tenkz_kernel_scratch_tl
                          {
                            ...
                            \exp_not:V \l__tenkz_kernel_r_b_tl
                          }
                      }
                  }
              }
...
\cs_new_protected:Npn \__tenkz_kernel_r_strings:
  {
    \prop_clear:N \l__tenkz_kernel_r_skin_over_string_prop
            ...
            \prop_if_in:NnTF
              \l__tenkz_kernel_skin_pairing_host_prop {#1}
              {
                \exp_args:NV \__tenkz_render_labelnode:nnn
                  ...
                  { \phantom { $ \cdots $ } }
                \__tenkz_kernel_r_skin_wires:n {#1}
                \__tenkz_kernel_r_skin_over_strings:n {#1}
...
\cs_new_protected:Npn \__tenkz_kernel_r_skin_over_strings:n #1
  {
    \prop_get:NnN \l__tenkz_kernel_r_skin_over_string_prop {#1}
      \l__tenkz_kernel_r_tl
    \quark_if_no_value:NF \l__tenkz_kernel_r_tl
      {
        % The opaque base is drawn after the ordinary string pass.  Redraw
        % only the declared over-strand, clipped to this host's measured box,
