% tenkz-kernel-resolve.code.tex
%
% This file is the resolution stage: placement, plane-ratio guards, the address
% dependency graph, points on a curve, the selector and its offset hull, the
% equation's shared measure, cell sets, hull routes, and physical-leg lanes.
%
% It was split out of tenkz-kernel.code.tex without changing a line of
% its content; the stages load in the order tenkz.sty lists them and the
