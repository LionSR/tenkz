...
% tenkz-kernel-annotate.code.tex
%
% This file is the annotation stage: where a name or a mark may stand.  The automatic
% label station, concentric containment, mark ink, and the layering of
% annotations against generated returns.  This runs after geometry and
% before the page is closed, because a station is a layout question.
%
