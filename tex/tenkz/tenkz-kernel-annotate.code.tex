...
% A smooth routed string exposes its exact arclength tangent through the same
% marking traversal that placed the bead.  Orthogonal corners need both
% one-sided tangents, and a circle cannot yet certify labels against unrelated
% chords, so those deliberately retain conservative blindness here.
