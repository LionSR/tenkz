...
\def\tenkz@resolveglyphshape#1#2{%
  ...
  \tenkz@glyphouterxsep=\csname tenkz@glyphouterx@#2\endcsname\relax
  \tenkz@glyphouterysep=\csname tenkz@glyphoutery@#2\endcsname\relax
...
\def\tenkz@captureglyphgeometrynode#1#2#3#4{%
  \iftenkz@bboxcapture
    ...
    \fi
  \fi
  \global\expandafter\let\csname tenkz@glypharcflag@#4\endcsname\relax
  \global\expandafter\let\csname tenkz@glypharc@#4\endcsname\relax
  \global\expandafter\let\csname tenkz@glyphouterx@#4\endcsname\relax
  \global\expandafter\let\csname tenkz@glyphoutery@#4\endcsname\relax}
