...
\def\tenkz@capturelabelbbox{%
  \iftenkz@bboxcapture
    ...
    \fi
  \fi}
\def\tenkz@captureglyphgeometry{%
  \iftenkz@bboxcapture
    \ifnum\tenkz@pictureid>0\relax
      \tenkz@inkowner=\tenkz@glyphowner
      \tenkz@emitglyphgeometry{\tikzlastnode}%
    \fi
  \fi}
\def\tenkz@beginglyphgeometry#1#2{%
  \iftenkz@bboxcapture
    \ifnum\tenkz@pictureid>0\relax
      \global\advance\tenkz@inkuid by 1\relax
      \global\tenkz@glyphowner=\tenkz@inkuid
      \global\tenkz@glyphradius=#2\relax
      \xdef\tenkz@glyphshape{#1}%
      \tenkz@event{ink-use|picture=\the\tenkz@pictureid|class=glyph|%
        id=\the\tenkz@glyphowner|shape=#1}%
    \fi
  \fi}
...
\def\tenkz@emitmanualglyphbbox#1{%
  \begingroup
  \tenkz@beginglyphgeometry{rect}{0pt}%
  \tenkz@inkowner=\tenkz@glyphowner
...
\tikzset{
  ...
  tenkz audited glyph/.style 2 args={
    /utils/exec={\tenkz@beginglyphgeometry{#1}{#2}},
    append after command={\pgfextra{\tenkz@captureglyphgeometry}}},
}
