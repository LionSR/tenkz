...
\tikzset{
  ...
  tn label/.style={tenkz audited label, text=tenkzInk, inner sep=1pt,
      font=\scriptsize},
...
% Labels and explicit wire nodes use live rectangles.  Core glyph nodes also
% retain their shape: circles use live cardinal anchors, rounded rectangles
% carry the production corner radius, and triangles use live corner anchors.
% Typed-map wire rectangles use endpoint anchors plus the stroke's vertical
% half-width; both caps terminate under opaque nodes, so longitudinal cap ink
% is not visible.
...
\def\tenkz@writebbox#1{%
  ...
  \tenkz@event{bbox|picture=\the\tenkz@pictureid|class=#1|%
    ...
    ymax=\number\tenkz@bboxymax}}
\def\tenkz@emitnodebbox#1#2{%
  \begingroup
  \pgfextractx{\tenkz@bboxxmin}{\pgfpointanchor{#2}{west}}%
  \pgfextractx{\tenkz@bboxxmax}{\pgfpointanchor{#2}{east}}%
  \pgfextracty{\tenkz@bboxymin}{\pgfpointanchor{#2}{south}}%
  \pgfextracty{\tenkz@bboxymax}{\pgfpointanchor{#2}{north}}%
  \tenkz@writebbox{#1}%
  \endgroup}
\def\tenkz@capturelabelbbox{%
  \iftenkz@bboxcapture
    \ifnum\tenkz@pictureid>0\relax
      \tenkz@emitnodebbox{label}{\tikzlastnode}%
    \fi
  \fi}
...
\def\tenkz@snapshotglyphcorners#1{%
  \pgfmathsetlength{\pgf@x}{\pgfkeysvalueof{/pgf/outer xsep}}%
  \expandafter\xdef\csname tenkz@glyphouterx@#1\endcsname{\the\pgf@x}%
  \pgfmathsetlength{\pgf@y}{\pgfkeysvalueof{/pgf/outer ysep}}%
  \expandafter\xdef\csname tenkz@glyphoutery@#1\endcsname{\the\pgf@y}%
  \ifpgf@arccorners
...
\def\tenkz@readglyphcorners#1{%
  \tenkz@glyphouterxsep=\csname tenkz@glyphouterx@#1\endcsname\relax
  \tenkz@glyphouterysep=\csname tenkz@glyphoutery@#1\endcsname\relax
...
\def\tenkz@captureglyphgeometry#1#2#3{%
  \iftenkz@bboxcapture
    \ifnum\tenkz@pictureid>0\relax
      \global\advance\tenkz@inkuid by 1\relax
      \tenkz@inkowner=\tenkz@inkuid
      \tenkz@resolveglyphshape{\tikzlastnode}{#3}%
      \tenkz@emitglyphinkuse
      \tenkz@emitglyphgeometry{\tikzlastnode}%
    \fi
  \fi
  \global\expandafter\let\csname tenkz@glypharcflag@#3\endcsname\relax
  \global\expandafter\let\csname tenkz@glypharc@#3\endcsname\relax
  \global\expandafter\let\csname tenkz@glyphouterx@#3\endcsname\relax
  \global\expandafter\let\csname tenkz@glyphoutery@#3\endcsname\relax}
\def\tenkz@emitglyphgeometry#1{%
  ...
  \ifx\tenkz@glyphshape\tenkz@roundrect
    ...
    \advance\tenkz@glyphwidth by -\tenkz@glyphouterxsep
    \advance\tenkz@glyphwidth by -\tenkz@glyphouterxsep
    \tenkz@glyphheight=\tenkz@bboxymax
    \advance\tenkz@glyphheight by -\tenkz@bboxymin
    \advance\tenkz@glyphheight by -\tenkz@glyphouterysep
    \advance\tenkz@glyphheight by -\tenkz@glyphouterysep
  ...
  \ifx\tenkz@glyphshape\tenkz@triangle
    \pgfextractx{\tenkz@glyphxone}{\pgfpointanchor{#1}{apex}}%
    \pgfextracty{\tenkz@glyphyone}{\pgfpointanchor{#1}{apex}}%
    \pgfextractx{\tenkz@glyphxtwo}{\pgfpointanchor{#1}{left corner}}%
    \pgfextracty{\tenkz@glyphytwo}{\pgfpointanchor{#1}{left corner}}%
    \pgfextractx{\tenkz@glyphxthree}{\pgfpointanchor{#1}{right corner}}%
    \pgfextracty{\tenkz@glyphythree}{\pgfpointanchor{#1}{right corner}}%
  \else
  ...
  \endgroup}
\def\tenkz@emitmanualglyphbbox#1{%
  \begingroup
  \global\advance\tenkz@inkuid by 1\relax
  \tenkz@inkowner=\tenkz@inkuid
  \tenkz@glyphradius=0pt
  ...
  \else
    \def\tenkz@glyphshape{unsupported}%
    \PackageError{tenkz}{Typed-map object '#1' has unsupported live shape
      '\tenkz@livepgfshape'}{Use a circle, rectangle, or isosceles triangle.}%
  \fi\fi\fi
  \tenkz@emitglyphinkuse
...
\tikzset{
  tenkz audited label/.style={
    /utils/exec=\tenkz@bboxlabeluse,
    append after command={\pgfextra{\tenkz@capturelabelbbox}}},
  ...
  \iftenkz@bboxcapture
    \ifnum\tenkz@pictureid>0\relax
      ...
      \edef\tenkz@installglyphsnapshot{%
        \noexpand\tikzset{%
          execute at end node={%
            \noexpand\tenkz@snapshotglyphcorners{\tenkz@glyphsnaptoken}},%
