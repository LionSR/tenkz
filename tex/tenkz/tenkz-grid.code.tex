        ...
        {dot}
          {
            ...
            % the migration experiment: same node, same name, same point --
            % but the mapped point crosses geometry and the ink primitive
            \bool_if:NTF \g__tenkz_experiment_render_bool
              {
                ...
                \__tenkz_geom_place_cell:nnee { cell:#1-#2 } {gridflat}
                  ...
                  { \fp_eval:n { \dim_to_fp:n { \l__tenkz_my_dim }
                                / \dim_to_fp:n { \tenkz@pitch } } }
                \__tenkz_render_atom_named:nn { cell:#1-#2 }
                  { tensor, \l__tenkz_rolesty_tl ,
                    name = \tenkz_node_name:nn{#1}{#2} }
              }
              {
