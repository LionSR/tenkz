...
% tenkz-kernel-language.code.tex
%
% This file is the language stage of the 1.0 kernel: diagnostics, kernel state, the
% address grammar, every key tree, record helpers, sugar expansion, the
% event stream, boundary signatures, and the seven public commands.
%
