...
% OFF by default.  When set, qualifying legacy paths hand their ink to this
% stage; the toggle is an internal experiment hook, not public syntax.
\bool_new:N \g__tenkz_experiment_render_bool
\cs_new_protected:Npn \tenkz@experimentrender
  { \bool_gset_true:N \g__tenkz_experiment_render_bool }
