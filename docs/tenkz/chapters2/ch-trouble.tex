...
object should this tensor network represent?  A quantum state $|\psi\rangle$
carries open physical legs and closed virtual boundaries; a transfer operator
or MPO carries open virtual indices at both ends; and an expectation value or
partition function is a fully contracted scalar with an empty boundary
signature.  When inspecting an equation, compare the boundary signatures of each
