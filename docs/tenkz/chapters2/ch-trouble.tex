...
object should this diagram represent?  A matrix requires two open virtual
indices; a doubled-space transfer map requires four; and a scalar requires none
at all.  When inspecting an equation, compare the boundary signatures of each
side term by term, rather than merely counting total legs on the page.
