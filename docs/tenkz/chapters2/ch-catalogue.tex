...
\tncmd{tnset} carries the same policy at document scope.  Three keys live
there: \tnkey{pitch=}, the one base metric every named ratio follows;
\tnkey{theme=}, the semantic ink; and \tnkey{strict}, which rejects every
sugar spelling in the registry.
