...
| `rmp-iii-b-condensation` | K3 | Corrected 2026-08-30: neither the verdict note nor authoritative source lines 925-953 contain the previously alleged finite projection mark. The real residue is family geometry: bowed rather than taut marked strings and the contract bilayer's diagonal sheet pairing against the source's vertical drop. |
...
| `rmp-workbench-iii-mpo-on-peps-definition` | K3 | Source-backed repair 2026-09-05 restores the separate PEPS star, eight radial MPO openings and red ring; removes the invented central A. Flat projection and panel proportions remain cosmetic; the source schematic has different left/right boundary counts. |
