...
# and `boundary` are cross-cutting/derived and are stripped from a
# picture's content before this table is consulted (see Picture.content),
# so listing them here is harmless but never load-bearing.
DIALECT_KINDS = {
